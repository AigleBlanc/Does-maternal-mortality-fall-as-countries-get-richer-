...
[OWiD author's article](https://ourworldindata.org/maternal-mortality#does-maternal-mortality-fall-as-countries-get-richer)

[OWiD author's visualization](https://ourworldindata.org/grapher/maternal-mortality-ratio-vs-gdp-per-capita)
...
sh1 = gc.open_by_url("https://docs.google.com/spreadsheets/d/1sZJIAy2i-MGxAgeXrIYsTk3RNZzTWCX8E61J1G1evKg/edit?usp=sharing")

worksheet = sh1.worksheet("mmr_gdp_per_capita")
...
sh2 = gc.open_by_url("https://docs.google.com/spreadsheets/d/1Pv7GJ3BvOPRZdsjwPXSdQdK0QDisfetshCNlTk0HhMg/edit?usp=sharingg")

worksheet = sh2.worksheet("GNI_per_capita")
...
sh3 = gc.open_by_url("https://docs.google.com/spreadsheets/d/19BUVFcBzskRYIvO3AylPMMQ4zvyAist0CN8H4xjmBM8/edit?usp=sharing")

worksheet = sh3.worksheet("data3_gni")
rows3 = worksheet.get_all_values()
#We would be working with this dataframe now onwards
data_gni = pd.DataFrame.from_records(rows3)
data_gni.columns = ['country', 'gni_1990', 'gni_2015']
